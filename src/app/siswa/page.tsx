                        ...
                        {isFinished ? (
                          <>
                            {ujian.tampilkanHasil ? (
                              ...
                              <div className="p-3 rounded-2xl bg-slate-50/90 dark:bg-slate-900/60 border border-slate-200/80 dark:border-white/10 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <div className="w-8 h-8 rounded-xl bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-bold">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-[10px] text-slate-500 dark:text-slate-400">
                                      Jawaban tersimpan aman (Nilai disembunyikan)
                                    </div>
                                  </div>
                                </div>
                                <span className="px-2.5 py-1 rounded-lg bg-emerald-100 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 text-[10px] font-bold">
                                  Tuntas
                                </span>
                              </div>
                            )}
                          ...
                          ujian.tampilkanHasil !== false ? (
                            ...
                            <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 flex items-center gap-2.5">
                              ...
                              <div>
                                ...
                                <div className="text-[10px] text-slate-500 dark:text-slate-400">
                                  Nilai dirahasiakan oleh penguji
                                </div>
                              </div>
                            </div>
                          )
